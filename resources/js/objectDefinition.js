...
var theRocksFilms = [
    ...
    },
    {
        ...
        image: 'Moana.jpg',
        trailer : '<iframe src="https://www.youtube.com/embed/Dadu2KLjMVM" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        Title : "San Andreas",
        Description : "A seemingly ideal day turns disastrous when California's notorious San Andreas fault triggers a devastating, magnitude 9 earthquake, the largest in recorded history. As the Earth cracks open and buildings start to crumble, Ray Gaines (Dwayne Johnson), an LAFD search-and-rescue helicopter pilot, must navigate the destruction from Los Angeles to San Francisco to bring his estranged wife (Carla Gugino) and their only daughter (Alexandra Daddario) to safety.",
        image : 'SanAndreas.jpg',
        trailer : '<iframe src="https://www.youtube.com/embed/Bz9e0PGSDeU" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'

    },
    {
        Title : "Hercules",
        Description : "Though he is famous across the ancient world for his larger-than-life exploits, Hercules (Dwayne Johnson), the son of Zeus and a human woman, is haunted by his tragic past. Now, he fights only for gold as a traveling mercenary, accompanied by a band of loyal followers, including Amphiarus (Ian McShane) and Autolycus (Rufus Sewell). However, when the benevolent ruler of Thrace and his daughter seek his help in defeating a savage warlord, Hercules must find the true hero within himself once again.",
        image : 'Hercules.jpg',
        trailer : '<iframe  src="https://www.youtube.com/embed/GFqY089piQ4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        Title : "Doom",
        Description : "A team of space marines known as the Rapid Response Tactical Squad, led by Sarge (The Rock), is sent to a science facility on Mars after somebody reports a security breach. There, they learn that the alert came after a test subject, a mass murderer purposefully injected with alien DNA, broke free and began killing people. Dr. Grimm (Rosamund Pike), who is related to team member Reaper (Karl Urban), informs them all that the chromosome can mutate humans into monsters -- and is highly infectious.",
        image: 'Doom.jpg',
        trailer : '<iframe  src="https://www.youtube.com/embed/LljkKoPs1Gg" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        Title : "The Rundown",
        Description : "Beck (The Rock) is a tight-lipped bounty hunter who doesn't like to use a gun and accepts any job without asking questions. When Beck's employer, Walker (William Lucking), sends him to the Amazon to locate Walker's cocky son, Travis (Seann William Scott), Beck discovers a population controlled by a tyrannical treasure hunter (Christopher Walken). To survive, Beck and Travis must work together, without their affections for a mysterious rebel (Rosario Dawson) getting in the way.",
        image : 'TheRundown.jpg',
        trailer : '<iframe  src="https://www.youtube.com/embed/2-d1LJ66Nyw" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        Title : "Central Intelligence",
        Description : "Bullied as a teen for being overweight, Bob Stone (Dwayne Johnson) shows up to his high school reunion looking fit and muscular. While there, he finds Calvin Joyner (Kevin Hart), a fast-talking accountant who misses his glory days as a popular athlete. Stone is now a lethal CIA agent who needs Calvin's number skills to help him save the compromised U.S. spy satellite system. Together, the former classmates encounter shootouts, espionage and double-crosses while trying to prevent worldwide chaos.",
        image: 'CentralIntelligence.jpg',
        trailer: '<iframe src="https://www.youtube.com/embed/MxEw3elSJ8M" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>'
    },
    {
        Title : "The Game Plan",
